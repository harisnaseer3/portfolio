                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-premium sm:rounded-[2.5rem] border border-gray-100 p-8 md:p-12">
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
                            <div>
                                <h3 className="text-lg font-bold text-gray-900">Your Degrees & Certifications</h3>
                                <p className="text-gray-500 text-sm">Manage your academic achievements and professional certifications.</p>
                            </div>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {education.map((edu) => (
                                <div key={edu.id} className="bg-white p-6 rounded-2xl border border-gray-100 hover:border-primary/20 hover:shadow-lg transition-all group">
                                    ...
                                    <h4 className="text-lg font-bold text-gray-900 mb-1">{edu.title}</h4>
                                    <p className="text-sm font-bold text-primary mb-2 uppercase tracking-widest">{edu.institution}</p>
                                    <p className="text-xs text-gray-500 line-clamp-2 mb-4 italic">"{edu.description}"</p>
                ...
                <form onSubmit={submit} className="p-8">
                    ...
                    <div className="space-y-6">
                        <div className="grid grid-cols-2 gap-6">
                            <div>
                                <InputLabel htmlFor="title" value="Degree / Certification Title" />
                                <TextInput
                                    id="title"
                                    type="text"
                        ...
                        <div>
                            <InputLabel htmlFor="duration" value="Duration / Year" />
                            <TextInput
                                id="duration"
                                type="text"
                                className="mt-1 block w-full !rounded-xl"
                        ...
                        <div>
                            <InputLabel htmlFor="description" value="Key Achievements / Description" />
                            <textarea
                                id="description"
                        ...
                        <div className="grid grid-cols-3 gap-6">
                            ...
                            <div>
                                <InputLabel htmlFor="credential_url" value="Verify URL (Link)" />
                                <TextInput
                                    id="credential_url"
                                    type="url"
                                    className="mt-1 block w-full !rounded-xl"
